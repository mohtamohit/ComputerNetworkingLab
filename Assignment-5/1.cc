...
int main (int argc, char *argv[])
{
  ...
  p.SetChannelAttribute ("Delay", TimeValue (MilliSeconds (10)));
  ...
  NetDeviceContainer dev4 = p.Install (n1n2);
  ...
  AnimationInterface anim("animation-default.xml");
  ...
  std::string flow_name ("flow-default.xml");
  Simulator::Run ();
